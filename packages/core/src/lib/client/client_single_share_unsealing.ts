...
// Proof production moved to UnsealPathProducer; this class is now transport-only. The resolver/event
// types are re-exported from their new home so existing importers keep working unchanged.
export type { UnsealResolver, UnsealResolvers, UnsealModuleEvent } from "../unseal_conditions/UnsealPathProducer";
export { UnsealModulePhase, UnsealModuleError } from "../unseal_conditions/UnsealPathProducer";
