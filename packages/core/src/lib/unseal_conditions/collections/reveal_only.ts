...
// import { TopLevelTreeProof } from "../proofs/zk_proofs/002_top_level_tree_proof";
// import { SubTreeProof } from "../proofs/zk_proofs/001_sub_tree_proof";
...
// export class RevealOnlyCollection extends ChainedProofCollection {
...
//         var reveal_value_hash = treeHasher(reveal_value, 0n)
...
//             path: data_stream_merkle_proof[1].pathElements.map(element => element.toString()),
//             index_bits: data_stream_merkle_proof[1].pathIndices.map(index => index.toString())
//         });
//         return_proofs.push(sub_level_merkle_proof.proof)
//         return_public_inputs.push(sub_level_merkle_proof.publicSignals)
//         // subtree_root: Field;
...
//         return_proofs.push(top_level_merkle_proof.proof)
