...
export interface Opening_proofInterface extends Interface {
...
export interface Opening_proof extends BaseContract {
  connect(runner?: ContractRunner | null): Opening_proof;
  waitForDeployment(): Promise<this>;

  interface: Opening_proofInterface;
