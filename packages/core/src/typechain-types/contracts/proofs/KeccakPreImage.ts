...
export interface KeccakPreImageInterface extends Interface {
...
export interface KeccakPreImage extends BaseContract {
  connect(runner?: ContractRunner | null): KeccakPreImage;
  waitForDeployment(): Promise<this>;

  interface: KeccakPreImageInterface;
