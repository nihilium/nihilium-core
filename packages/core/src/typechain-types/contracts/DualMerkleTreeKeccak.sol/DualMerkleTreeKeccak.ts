...
export interface DualMerkleTreeKeccakInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIELD_SIZE"
      | "ROOT_HISTORY_SIZE"
...
export interface DualMerkleTreeKeccak extends BaseContract {
  connect(runner?: ContractRunner | null): DualMerkleTreeKeccak;
  waitForDeployment(): Promise<this>;

  interface: DualMerkleTreeKeccakInterface;
