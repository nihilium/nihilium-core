...
contract hash_tie {
    ...
    uint256 constant deltax1 = 12352275696373567781616345583482401613549849938283565620564281147871041882600;
    uint256 constant deltax2 = 9808469532522580582707662316707787516681088936157924141016938399695835847759;
    uint256 constant deltay1 = 20908908475914539783999594327919937750977263767881182649738998838749902651291;
    uint256 constant deltay2 = 13225640725721837331003632939950924769435192903369491534531686764355393826464;
     ...
     *   uint[2] _pC
     * )
     * Public inputs: bytes32[] (must be 2 elements)
     */
    function verify(bytes calldata _proof, bytes32[] calldata _publicInputs) external view returns (bool) {
        require(_publicInputs.length == 2, "Invalid number of public inputs");
        // Decode proof
        uint[2] memory _pA;
        uint[2][2] memory _pB;
        uint[2] memory _pC;
