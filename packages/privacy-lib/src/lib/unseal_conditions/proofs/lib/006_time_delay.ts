 ...
 */
export class TimeDelayProof extends UnsealConditionProof {
    ...
    protected id: string = "TimeDelayProof";
    protected name: string = "Time Delay Proof";
    protected description: string = "Time Delay Proof";
