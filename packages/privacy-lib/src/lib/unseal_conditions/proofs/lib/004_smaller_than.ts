 ...
 */
export class SmallerThanProof extends UnsealConditionProof {
    ...
    protected id: string = "SmallerThan";
    protected name: string = "Smaller Than Proof";
    protected description: string = "Smaller Than Proof";
    ...
    async create_proof(inputs: {[key: string]: any}): Promise<Proof> {
        if(inputs.timestamp >= inputs.threshold) {
