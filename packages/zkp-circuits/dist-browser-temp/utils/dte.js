...
import { generateRandom248BitNumber, encryptECCBabyJub, toBytesLE, decryptECCBabyJub } from "./tools"; // adjust to your actual module
...
export function FDTDecrypt(privateKeys, ciphertextMap, empheralKey) {
