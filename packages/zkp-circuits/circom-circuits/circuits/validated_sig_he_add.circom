...
template ValidatedSigHEAdd() {
    ...
    component poseidonPoint = Poseidon(16);
    poseidonPoint.inputs <== point_org;
    component poseidonEphemeral = Poseidon(16);
    ...
    component he_add = HomomorphicAdd();
    ...
    ephemeralKey_he <== he_add.ephemeralKey_he;
    point_he <== he_add.point_he;
